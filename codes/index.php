				...
				<div class="col-md-4 col-md-offset-4">
					...
					<form action="login.php" class="fh5co-form animate-box" data-animate-effect="fadeIn" method="post">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="Account" name="Account" placeholder="Account" autocomplete="off" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<p>Not registered? <a href="sign_up.php">Sign Up</a> </p>
						</div>
						<div class="form-group">
